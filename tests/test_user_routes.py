...
from API.routes import create_user, upload_image, get_user_images, get_image
...
def test_create_user(mock_db):
    ...
    with patch('API.routes.User') as MockUser, \
...
def test_upload_image(mock_db):
    ...
    with patch('API.routes.Image') as MockImage, \
